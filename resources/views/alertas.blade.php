                ...
                <tr>
                  ...
                  @php
                    ...
                    if($arreglo_alertas[$i]->evidencia != '')
                    {
                      ...
                      $ev1 = ($arreglo_alertas[$i]->evidencia->ruta_evidencia_1 != '') ? '/images/evidencia/'.substr($arreglo_alertas[$i]->evidencia->ruta_evidencia_1, 44) :'';
                      $ev2 = ($arreglo_alertas[$i]->evidencia->ruta_evidencia_2 != '') ? '/images/evidencia/'.substr($arreglo_alertas[$i]->evidencia->ruta_evidencia_2, 44) :'';
